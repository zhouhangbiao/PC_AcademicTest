  ...
  return function (a) {
    ...
    (function (b) {
      ...
      function h(a) {
        ...
        var d = new w({width: a.width, height: a.height}), e = d.Shape,
      ...
      function i(a, b, c) {
        var d = parseInt(a, 10), e = parseInt(b, 10), f = Math.max(d, e), g = Math.min(d, e),
      ...
      var v = c(1), w = c(2), x = c(3), y = x.extend, z = x.cssProps, A = x.encodeHtmlEntity, B = x.decodeHtmlEntity,
        C = x.imageExists, D = x.getNodeArray, E = x.dimensionCheck, F = "http://www.w3.org/2000/svg", G = 8,
        H = "2.6.0",
        I = "\nCreated with Holder.js " + H + ".\nLearn more at http://holderjs.com\n(c) 2012-2015 Ivan Malopinsky - http://imsky.co\n",
        J = {
          version: H, addTheme: function (a, b) {
            ...
            for (l = 0; l < i.length; l++)if (b.getComputedStyle) {
              var r = b.getComputedStyle(i[l], null).getPropertyValue("background-image"),
                s = i[l].getAttribute("data-background-src"), t = null;
              t = null == s ? r : s;
            ...
            for (l = 0; l < h.length; l++) {
              ...
              var J = null != I.src, L = null != I.dataSrc && 0 === I.dataSrc.indexOf(g.domain),
          ...
          return function (d) {
            ...
            if (K.setup.supportsSVG) {
              ...
              var j = b.getBBox(), k = Math.ceil(j.width / (e.properties.width * K.setup.lineWrapRatio)),
                l = i.text.split(" "), m = i.text.match(/\\n/g);
          ...
          if (b.XMLSerializer) {
            ...
            return c.appendChild(d), function (b, e) {
              ...
              var i = e.holderSettings.flags.holderURL,
                j = "holder_" + (Number(new Date) + 32768 + (0 | 32768 * Math.random())).toString(16), k = o("g", F),
                l = f.children.holderTextGroup, m = l.properties, n = o("g", F), s = l.textPositionData,
                t = "#" + j + " text { " + z({
                    fill: m.fill,
                    "font-weight": m.font.weight,
                    "font-family": m.font.family + ", monospace",
                    "font-size": m.font.size + m.font.units
                  }) + " } ", u = a.createComment("\nSource URL: " + i + I), v = a.createCDATASection(t),
              ...
              for (var x in l.children) {
                ...
                for (var A in y.children) {
                  var B = y.children[A], C = l.x + y.x + B.x, D = l.y + y.y + B.y, E = o("text", F),
    ...
    var d = c(4), e = function (a) {
      ...
      var c = 1, e = d.defclass({
        ...
        this.Group = d.extend(this, {constructor: c, type: "group"}), this.Rect = d.extend(this, {
          constructor: c,
          type: "rect"
    ...
    var b = function () {
      ...
      var e = b.prototype = "function" == typeof a ? a.prototype : a, f = new b,
