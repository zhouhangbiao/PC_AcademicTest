const history = {
   ...
   * @param next
   */
  viewMarkedQuestions: function (req, res, next) {
    res.send({
      ResultType: 1,
      Message: "",
      ReturnEntity: {
        "MarkQuestionStatus": 3,
        "ExamTaskNumber": "",
        "IsAbnormal": true,
   ...
   * @param next
   */
  getReviewedQuestionData: function (req, res, next) {
    res.send({
      ResultType: 1,
      Message: "",
      ReturnEntity: {
   ...
   * @param next
   */
  submitReviewedQuestionData: function (req, res, next) {
    res.send({
      ResultType: 1,
      Message: "",
      ReturnEntity: {
   ...
   * @param next
   */
  getJudgingHistoryList: function (req, res, next) {
    res.send({
      ResultType: 1,
      Message: "",
      ReturnEntity: {
