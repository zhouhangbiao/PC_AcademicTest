const task = {
   ...
   * @param next
   */
  getMarkingTasksList: function (req, res, next) {
    res.send({
      ResultType: 1,
      Message: "",
      ReturnEntity: {
        ...
        "MarkingTasks": [
          {
            "BatchId": 11,
            "MarkingTaskBatchStatus": 1,
            "TotalTaskCount": 0,
            "ReviewedTaskCount": 0,
            "WaitReviewTaskCount": 0,
            "TaskDeliveryDate": "2012-02-05 02:54",
            "LatestUploadTime": "2012-02-05 08:20"
          }, {
            "BatchId": 22,
            "MarkingTaskBatchStatus": 2,
            "TotalTaskCount": 1,
            "ReviewedTaskCount": 0,
            "WaitReviewTaskCount": 0,
            "TaskDeliveryDate": "2012-02-05 02:54",
   ...
   * @param next
   */
  submitQuestionData: function (req, res, next) {
    res.send({
      ResultType: 1,
      Message: "",
      ReturnEntity: {
   ...
   * @param next
   */
  setAsQuestionTest: function (req, res, next) {
    res.send({
      ResultType: 1,
      Message: "",
      ReturnEntity: {
   ...
   * @param next
   */
  getMarkingTasksData: function (req, res, next) {
    res.send({
      ResultType: 1,
      Message: "",
      ReturnEntity: {
        "PreviousBatchId": "11111",
        "NextBatchId": "22222",
        "BatchStatus": "2",
        "TaskIds": [
          "11111111111",
   ...
   * @param next
   */
  viewQuestionInformation: function (req, res, next) {
    res.send({
      ResultType: 1,
      Message: "",
      ReturnEntity: {
        "MarkQuestionStatus": 5,
        "IsAbnormal": true,
